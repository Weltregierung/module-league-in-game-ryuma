document.querySelector("#settings").addEventListener("submit", (e) => {
  ...
  LPTE.emit({
    ...
    autoTargetFrameCover: document.querySelector("#autoTargetFrameCover")
      .checked,
    scoreboard: {
...
function initSettings(settings) {
  ...
  document.querySelector("#autoTargetFrameCover").checked =
    settings.autoTargetFrameCover;
  ...
  document.querySelector("#events-test").addEventListener("change", (e) => {
    document.querySelector("#dragons-test").style.display =
      e.target.value === "Dragon" ? "block" : "none";
  });
}
